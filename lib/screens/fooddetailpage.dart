...
import 'package:buvapp/screens/basketpage.dart';
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text("Prix :",style: TextStyle(fontFamily: "Montserrat-Medium.ttf",fontSize: 25,),),


                Text(
                  " ${widget.yemek.yemek_fiyat} Dh",
                    ...
                    for (var i = 0; i < yemeklerListesi.length; i++) {
                      if (widget.yemek.yemek_adi == yemeklerListesi[i].yemek_adi) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          ...
                          content: Text("Ce produit est déja dans votre panier"),
                        ));
                        return;
                      }
                    }
